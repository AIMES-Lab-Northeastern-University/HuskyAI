...
from database import AsyncSessionLocal, Challenge, UserChallengeSession, Conversation
...
async def list_challenges(
    ...
    result = await db.execute(select(Challenge).where(Challenge.is_active == 1))
